            ...
            yes|y|YES|Y|o|O|oui|OUI)
                ...
                case $INSTALL_TYPE in
                    wordpress)
                        ...
                        WP_PLUGINS_ACTIVATE=(auto-image-attributes-from-filename-with-bulk-updater flush-opcache maintenance wp-fail2ban beautiful-and-responsive-cookie-consent duplicate-page stops-core-theme-and-plugin-updates header-footer-code-manager redirection https://cloud.bldwebagency.fr/s/9kk6H3SJnMzRMJj/download/duplicator-pro.zip https://cloud.bldwebagency.fr/s/7w7AFD8fi22sJn8/download/bldwebagency.zip)
                        WP_PLUGINS_INSTALL=(iwp-client redis-cache google-site-kit bing-webmaster-tools loco-translate https://cloud.bldwebagency.fr/s/6fzP5zkpf2QdYs3/download/wp-rocket.zip https://cloud.bldwebagency.fr/s/qcTBawwb3tQMo2d/download/wpforms.zip https://cloud.bldwebagency.fr/s/AtB6G7KkoCB4R6n/download/wp-mail-smtp-pro.zip)
