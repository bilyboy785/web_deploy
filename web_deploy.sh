            ...
            yes|y|YES|Y|o|O|oui|OUI)
                ...
                case $INSTALL_TYPE in
                    wordpress)
                        ...
                        WP_PLUGINS_ACTIVATE=(auto-image-attributes-from-filename-with-bulk-updater maintenance wp-fail2ban beautiful-and-responsive-cookie-consent duplicate-page stops-core-theme-and-plugin-updates header-footer-code-manager redirection https://cloud.bldwebagency.fr/s/7w7AFD8fi22sJn8/download/bldwebagency.zip)
                        WP_PLUGINS_INSTALL=(cdn-enabler advance-canonical-url iwp-client redis-cache google-site-kit opcache-manager wp-mail-smtp bing-webmaster-tools loco-translate https://cloud.bldwebagency.fr/s/P6NPmH9tCgq4kGW/download/updraftplus.2.23.1.zip https://cloud.bldwebagency.fr/s/SzYZgEaeKJSEi8c/download/perfmatters.zip https://cloud.bldwebagency.fr/s/6fzP5zkpf2QdYs3/download/wp-rocket.zip https://cloud.bldwebagency.fr/s/edJDXwGQrZTzBRb/download/wpforms.zip)
