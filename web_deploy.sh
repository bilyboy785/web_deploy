...
function init_server {
    ...
    DEBIAN_FRONTEND=noninteractive apt install -yqq git zsh curl wget htop python3 libacl1-dev bat pkg-config libattr1-dev libssl-dev liblz4-dev ripgrep exa fail2ban python3-venv python3-pip proftpd mariadb-client mariadb-server docker.io redis-server > /dev/null 2>&1
